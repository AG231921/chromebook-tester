...
!function(e, t) {
    ...
    var d = {
        attachTo: function(e, t) {
            ...
            !0 !== t.reactToKeydown && !1 === t.scanButtonKeyCode || e.addEventListener("keydown", this._handleKeyDown),
            this
        },
        ...
        decodeKeyEvent: function(e) {
            switch (iCode = e.which,
            !0) {
            case 48 <= iCode && iCode <= 90:
            case 106 <= iCode && iCode <= 111:
                if (void 0 !== e.key)
                    return e.key;
                var t = String.fromCharCode(iCode);
                switch (e.shiftKey) {
                case !1:
                    t.toLowerCase(t);
                    break;
                ...
                return t;
            case 96 <= iCode && iCode <= 105:
                return iCode - 96
            }
            return ""
        },
        simulate: function(e, t) {
            var n = e.scannerDetectionData.vars;
            return n.firstCharTime = 0,
            n.lastCharTime = 0,
            n.stringWriting = t,
            this._validateScanCode(e),
            this
        },
        ...
        _validateScanCode: function(e) {
            var t, n = e.scannerDetectionData, a = n.options, i = n.options.singleScanQty, o = n.vars.stringWriting, r = n.vars.firstCharTime, s = n.vars.lastCharTime, c = {};
            switch (!0) {
            case o.length < a.minLength:
                c = {
                    message: "Receieved code is shorter then minimal length"
                };
                break;
            case s - r > o.length * a.avgTimeByChar:
                c = {
                    message: "Receieved code was not entered in time"
                };
                break;
            default:
                return a.onScan.call(e, o, i),
                t = new CustomEvent("scan",{
                    detail: {
                        scanCode: o,
                        qty: i
                    }
            ...
            return c.scanCode = o,
            c.scanDuration = s - r,
            c.avgTimeByChar = a.avgTimeByChar,
            c.minLength = a.minLength,
            a.onScanError.call(e, c),
            t = new CustomEvent("scanError",{
                detail: c
            }),
            e.dispatchEvent(t),
            d._reinitialize(e),
        ...
        _getNormalizedKeyNum: function(e) {
            var t;
            return window.event ? t = e.keyCode : e.which && (t = e.which),
            t
        },
            ...
            !d._isFocusOnIgnoredElement(this))
                if (!1 === n.scanButtonKeyCode || t != n.scanButtonKeyCode) {
                    ...
                    case !a.firstCharTime && -1 !== n.prefixKeyCodes.indexOf(t):
                        ...
                        break;
                    default:
                        var i = n.keyCodeMapper.call(this, e);
                        if (null === i)
                            return;
                        a.stringWriting += i,
                        a.callIsScanner = !1
                    ...
                    a.callIsScanner ? (d._validateScanCode(this),
                    a.testTimer = !1) : a.testTimer = setTimeout(d._validateScanCode, n.timeBeforeScanTest, this),
                    n.onKeyProcess.call(this, i, e)
                } else
